...
class ProductSimilarity {
    ...
    public function getProductsSortedBySimilarity(int $productId, array $matrix): array
    {
    ...
    {
        $productAFeatures = $productA->meta_keywords;
        $productBFeatures = $productB->meta_keywords;
